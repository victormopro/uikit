...
export class ProfileCard extends React.Component{
    constructor(props) {
        ...
        this.dummyProfile = 'Graphic eater, hamburger designer, not necessarily in that order'
    }
    ...
    getProfile() {
        if(this.profile) {
            ...
            return this.dummyProfile;
        }
    }

    render() {
        let cardText = "I'm a 26-year-old art director and graphic designer based in London who loves to think and to create. I'm a calligraphy addict and an art lover. I'm a soldier and I would die for beauty. Why? Remember that the egg has a perfect shape despite coming out of an ass."
        return(
